...
export default function AddCandidate() {
  ...
  const [billingTerm, setBillingTerm] = React.useState(0);
              ...
              <Grid item xs={12}>
                <Autocomplete
                  ...
                  onChange={(e, v) => {
                    ...
                    setCandidate({
                      ...candidate,
                      skills: [...new Set([...remSkills, ...skillsToPush])],
                    });
                  }}
                    ...
                    <Grid item xs={4}>
                      ...
                      >
                        <DatePicker
                          ...
                          value={dayjs(candidate.invoiceCreditDate)}
                        />
                      </LocalizationProvider>
                    </Grid>
                    <Grid item xs={6}>
              ...
              {remarksList.map((remark) => (
                <Grid item xs={12}>
                  ...
                  >
                    ...
                    />
                    <CardContent>
                      <Typography variant="body">{remark.remarks}</Typography>
                    </CardContent>
                  </Card>
                </Grid>
              ))}
