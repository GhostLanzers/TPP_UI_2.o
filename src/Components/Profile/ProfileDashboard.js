    ...
    <div style={{ paddingLeft: "1vw", paddingRight: "1vw", paddingTop: "3vh" }}>
      ...
      >
        {[
          ...
          { label: "NEW CANDIDATES", color: "#FF0000", key: "newCandidates" },
          ...
          { label: "INTERVIEW SCHEDULED", color: "#00FFFF", key: "VirtualInterview" },
          { label: "INTERVIEW IN-PROCESS", color: "#FF00FF", key: "InterviewScheduled" },
          { label: "AWAITING JOINING", color: "#FF5C00", key: "AwaitingJoining" },
          { label: "OFFER DROP", color: "#FF0000", key: "OfferDrop" },
          { label: "TRACKING TENURE", color: "#00FF00", key: "TrackingTenure" },
          { label: "N2B", color: "#00FFFF", key: "N2B" },
          { label: "INVOICE PROCESSED", color: "#FF00FF", key: "InvoiceProcessed" },
          ...
          { label: "PROCESS RAMPDOWN", color: "#FF5C00", key: "ProcessRampdown" },
          { label: "CLIENT RAMPDOWN", color: "#FF0000", key: "ClientRampdown" },
          { label: "L1 & L2 WRONG NUMBERS", color: "#00FF00", key: "L1L2WrongNumbers" },
          { label: "L1 & L2 BLACKLIST", color: "#00FFFF", key: "L1L2Blacklist" },
          { label: "BUSINESS TRACKING", color: "#FF00FF", key: "BusinessTracking" },
        ].map((card, idx) => (
