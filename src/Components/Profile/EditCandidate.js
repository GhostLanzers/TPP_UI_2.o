                  ...
                  <Grid item xs={editable ? 9 : 6}>
                    <TextField
                      ...
                      onChange={(e) => {
                        ...
                        setCandidate({ ...candidate, mobile: candidate.mobile });
                      }}
                      fullWidth
                      InputProps={{
                        readOnly: !editable,
            ...
            <Grid container rowSpacing={2} columnSpacing={1}>
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    setCandidate({ ...candidate, l1Assessment: e.target.value })
                  }
                  fullWidth
                  InputProps={{
                    readOnly: !editable,
                ...
                <>
                  <Grid item xs={6}>
                    <Autocomplete
                      ...
                      onChange={(e, newValue) => {
                        setCandidate({ ...candidate, companyId: newValue });
                  ...
                  <Grid item xs={6}>
                    <Autocomplete
                      ...
                      onChange={(e, newValue) => {
                        setCandidate({ ...candidate, roleId: newValue });
                      }}
                      renderInput={(params) => (
                        <TextField
                          {...params}
