...
export default function EditEmpanelled() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const remarksRes = await AxiosInstance.get("/remarks/company/" + id);
  ...
  const handleRoleDelete = async () => {
    try {
      await AxiosInstance.delete("/company/" + id + "/role/" + deleteData._id);
      setCompany({
        ...company,
                                ...
                                >
                                  ...
                                  <TableCell>
                                    ...
                                    >
                                      ...
                                      {editable && y.HRMobile.length > 0 && (
                                        <>
                                          <Grid item xs={editable ? 2 : 0}>
                                            <IconButton
                                              size="small"
                                              color="primary"
                  ...
                  <Grid container rowSpacing={2} columnSpacing={1}>
                    ...
                    <Grid item xs={2}>
                      <Button
                        ...
                        disabled={
                          !editable && remarks.trim() === "" ? true : false
                        }
                      >
                        Post
                      </Button>
